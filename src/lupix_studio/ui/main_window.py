...
from lupix_studio.ui.animation_component_editor import (
...
class MainWindow(QMainWindow):
    ...
    def _create_inspector_dock(self) -> None:
        ...
        self.animation_editor = AnimationComponentEditor()
        ...
        self.tilemap_editor.tilemap_changed.connect(
            self._on_tilemap_changed
        )

        self.tilemap_editor.edit_requested.connect(
    ...
    def _open_project(
        ...
        self.animation_editor.set_context(
            None,
            None,
        )
        ...
        self.tilemap_editor.set_context(
            None,
            None,
            None,
        )
    ...
    def _on_scene_tree_component_selected(
        ...
        section_map = {
            ...
            "animation": (
                EntityInspectorPanel.SECTION_ANIMATION
            ),
            "camera": (
    ...
    def _on_area2d_changed(
        ...
        # Não reconstruir o Inspector/Area2D durante este signal.
